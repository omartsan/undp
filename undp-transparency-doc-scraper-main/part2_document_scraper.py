...
#Score Keywords:
#Good if score >=4
project_title = ['project title','title of the program','programme title', 'title of program', 'award title', 'de projet', 'titulo proyecto', 'titulo de proyecto', 'título proyecto', 'de proyecto','titulo del proyecto', 'título del proyecto', 'nombre del proyecto']
